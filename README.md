...
To evaluate this hypothesis, we will implement Pearson's Chi-squared test with Yates' continuity correction since we are working with qualitative data.
